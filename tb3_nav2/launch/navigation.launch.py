...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(tb3_nav2_dir, 'params', 'nav2_params.yaml'),
    ...
    declare_mapper_online_async_param_cmd = DeclareLaunchArgument(
        'async_param',
        default_value=os.path.join(tb3_nav2_dir, 'config', 'mapper_params_online_async.yaml'),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(tb3_nav2_dir, 'params', 'tb3.rviz'),
